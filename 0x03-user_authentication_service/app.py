...
def update_password():
    ...
    Expects:
    - email: form data (str)
    - reset_token: form data (str)
    - new_password: form data (str)

    Returns:
    - JSON with email and message on successful password update
    - 403 status code if the reset_token is invalid
    """
    email = request.form.get("email")
