...
### _Hash Password_
In this task you will define a \_hash\_password method that takes in a password string arguments and returns bytes.
...
If not, hash the password with \_hash\_password, save the user to the database using self.\_db and return the User object.
...
### _16. Generate Reset Password Token_
In this task, you will implement the Auth.get_reset_password_token method. It take an email string argument and returns a string.

Find the user corresponding to the email. If the user does not exist, raise a ValueError exception. If it exists, generate a UUID and update the user’s reset_token database field. Return the token.

### _17. Get Reset Passowrd Token_
...
### _20. End-to-end integration test_
